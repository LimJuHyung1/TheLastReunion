...
public class EndSceneManager : MonoBehaviour
{
    ...
    {
        nasonEnd = new string[] {
            "네이슨을 범인으로 지목하자, 네이슨은 고개를 숙인 채 한숨을 내쉽니다.",
            "그는 한참 동안 침묵하다가 차분한 목소리로 말합니다.",
            "\"정말로 제가 범인이라고 생각하십니까?\"",
            "\"앨런과 오랜 친구로서 갈등도 있었고\n그의 지병으로 인해 화가 난 적도 많았습니다.\"",
            "\"하지만, 앨런을 죽일 이유는 없습니다!\"",
            "\"저는 그를 도우려 했을 뿐입니다.\"",
            "네이슨의 눈은 슬픔으로 가득 차 있으며",
            "자신이 친구를 죽였다고 오해받은 것에 대한 상처가 깊이 배어 있습니다.",
            "조사 과정에서 그는 앨런을 위해 헌신했지만\n사업 문제와 앨런의 우울증 때문에 자주 충돌하게 되었음을 설명합니다.",
            "사건이 종결될 무렵, 경찰은 새롭게 발견된 증거를 통해 제니가 진범임을 밝혀냅니다.",
            "제니가 앨런에 대해 오랫동안 품어왔던 분노와 복수심이 범행의 동기였음을 확인하였습니다.",
            "하지만 앨런이 회사의 자금을 이용하여 투기성 투자를 한 사실 또한 밝혀졌고",
            "이에 네이슨이 가담한 사실도 밝혀졌습니다.",
            "네이슨은 법적 책임을 피할 수 없게 되며",
            "살인 혐의에서는 벗어났지만 회계 부정과 자금 유용에 대한 책임을 지고 법정에 서게 됩니다.",
            "그는 차분하게 법정으로 향하며 자신의 죄를 받아들이기로 결심합니다.",
            "네이슨은 친구를 위해 내린 잘못된 선택을 평생 동안 짊어지게 될 것입니다.",
            "정의는 실현되었으나, 우정과 욕심이 얽힌 추억은 어두운 그림자 속에 사라졌습니다."
        };

        jennyEnd = new string[] {
            "제니를 범인으로 지목하자 얼굴에 씁쓸한 미소를 띠며 천천히 고개를 듭니다.",
            "\"그래요, 제가 했습니다.\"",
            "\"앨런이 내게 남긴 상처는 너무나 깊었고\n그를 그냥 두고 볼 수는 없었습니다.\"",
            "제니의 목소리에는 긴 세월 동안 억눌려 온 분노와 상처가 배어 있으며",
            "감정이 터져 나올 듯이 흔들리고 있습니다.",
            "제니는 대학 시절부터 앨런에게 느꼈던 열등감과 무시당한 경험을 고백합니다.",
            "그녀는 항상 앨런보다 뒤처진다는 생각에 괴로워했고",
            "앨런이 자신의 신약 연구 프로젝트를 무산시키며\n마지막 희망마저 짓밟았을 때 모든 인내심이 한계에 다다랐다고 말합니다.",
            "그녀는 이번 모임이 앨런에게 복수할 수 있는 절호의 기회라고 생각했고",
            "그를 독살할 계획을 세웠다고 고백합니다.",
            "그녀는 앨런에게 마지막 복수를 결심했을 때 느꼈던 차가운 만족감을 떠올리며",
            "앨런이 자신에게 남긴 상처만큼 그에게도 고통을 안기고 싶었다고 말합니다.",
            "그러나 그 복수가 끝난 뒤, 자신에게 남은 것은 공허함뿐이었다고 덧붙입니다.",
            "제니는 모든 죄를 인정하고 체포됩니다.",
            "복수는 그녀에게 일시적인 만족감을 주었지만",
            "그녀는 더 큰 공허함과 상실감을 느끼며\n앨런의 그림자에서 벗어나지 못하는 자신을 발견합니다",
            "분노와 복수의 끝에서 제니는 고독한 결말을 맞이했습니다.",            
        };

        minaEnd = new string[] {
            "미나를 범인으로 지목하자, 충격에 사로잡혀 아무 말 없이 잠시 눈을 감고 깊은 숨을 내쉽니다.",
            "그녀는 천천히 고개를 들어 침울한 표정으로 조용히 입을 엽니다.",
            "\"앨런을 사랑했습니다...\"",
            "\"하지만 그의 죽음을 바란 적은 없습니다.\"",
            "\"그에게 남아 있던 제 마음은 오로지 사랑과 미련이었어요.\"",
            "\"그가 떠난 지금, 그마저도 잃어버린 셈이죠.\"",
            "앨런과 대학 시절 연인이었다는 것,",
            "그가 사업을 시작하면서 멀어졌지만 여전히 그를 사랑했음을 고백합니다.",
            "그녀는 앨런이 자신을 초대했을 때\n서로의 관계를 회복하려 한다고 믿고 흔쾌히 수락했다는 사실을 털어놓습니다.",
            "경찰은 사건을 재조사하여 새로운 증거를 통해 진범이 제니임을 밝혀냅니다.",
            "제니가 앨런에 대해 오랫동안 품어왔던 분노와 복수심이 범행의 동기였음을 확인하였습니다.",
            "미나는 사랑했던 사람을 잃고\n그를 죽였다는 의심까지 받으며 깊은 상처를 입었습니다.",
            "그녀의 마지막 선택은 씁쓸한 여운을 남기며\n사랑과 미련이 만들어낸 비극으로 마무리되었습니다.",
            "미나는 그리움 속에 영원히 잠들어\n어딘가에 있을 그녀의 사랑과 영원히 함께하려 할 것입니다."
        };
    }
